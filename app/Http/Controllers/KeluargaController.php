...
class KeluargaController extends Controller
{
    ...
    public function listWarga(Request $request, $no_kk)
    {
        ...
        $kepalaKeluarga = Warga::where('no_kk', $no_kk)->where('status_keluarga', 'Kepala Keluarga')->whereNotIn('status_warga', ['Tidak Aktif', 'Menunggu'])->get();
        $otherKepalaKeluarga = Warga::where('no_kk', $no_kk)->where('status_keluarga', '!=' , 'Kepala Keluarga')->whereNotIn('status_warga', ['Tidak Aktif', 'Menunggu'])->get();
        // $mergedWarga = ;
        $keluarga->warga = $kepalaKeluarga->merge($otherKepalaKeluarga);
        $warga = DataTables::of($keluarga->warga)
            ->addIndexColumn() // menambahkan kolom index / no urut (default namakolom: DT_RowIndex)
