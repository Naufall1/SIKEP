    ...
    <div class="tw-flex tw-gap-3 tw-items-center">
        <div class="nav-notify tw-cursor-pointer tw-h-11 tw-w-11 tw-flex tw-justify-center tw-items-center hover:tw-bg-n200 tw-rounded-md"
            ...
            <div class="tw-relative tw-flex tw-justify-center">
                <x-icons.actionable.notification class="tw-bg-cover" stroke="1.5" color="n1000"></x-icons.actionable.notification>
                <div
        ...
        <div
            class="tw-relative nav-profile tw-h-11 tw-min-w-11 tw-justify-center tw-flex md:tw-h-11 md:tw-gap-2 md:tw-px-3 tw-rounded-md">
            <div id="toggleProfil"  class="tw-h-11 tw-min-w-11 tw-justify-center tw-flex md:tw-h-11 md:tw-gap-2 md:tw-px-3 tw-rounded-md tw-items-center tw-cursor-pointer hover:tw-bg-n200">
                ...
                <x-icons.actionable.arrow-down-1 id="dropdownProfil" class="tw-hidden md:tw-inline-block tw-animate-180" stroke="2" size="24" color="n1000"></x-icons.actionable.arrow-down-1>
                <x-icons.actionable.profile-circle class="tw-bg-cover md:tw-hidden" stroke="1.5" color="n1000"></x-icons.actionable.profile-circle>
            </div>
                <div id="profilMenu"
                ...
                <div class="tw-flex tw-gap-1 tw-w-full">
                    <a href="{{ route('profil') }}"
                        ...
                        <x-icons.actionable.profile-circle stroke="2" size="20" color="n1000"></x-icons.actionable.profile-circle>
                ...
                <div class="tw-flex tw-gap-1 tw-w-full">
                    <a href="{{ route('logout') }}"
                        ...
                        <x-icons.actionable.logout class="tw-stroke-r500" stroke="2" size="20" color="r500"></x-icons.actionable.logout>
