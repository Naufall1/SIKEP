<div class="tw-pt-[100px] tw-px-5 tw-w-full tw-flex tw-flex-col tw-gap-2 tw-pb-10">
    <div class="tw-flex tw-items-center md:tw-items-start {{ $canEdit ? 'tw-justify-between' : '' }} ">
        ...
        @php
            if ($canEdit) {
                echo '<a href=""class="tw-h-10 tw-px-4 md:tw-h-11 md:tw-px-6 tw-bg-b500 tw-text-n100 tw-font-sans tw-font-bold tw-text-base tw-rounded-full hover:tw-bg-b600 active:tw-bg-b700 tw-flex tw-items-center"> Tambah Data</a>';
            }
        @endphp
