    ...
    <div class="tw-flex tw-w-full tw-flex-col tw-gap-7 md:tw-gap-8 md:tw-justify-between md:tw-flex-row">
        <div class="tw-flex tw-flex-col tw-gap-5 md:tw-gap-8 ">
            <div class="tw-flex tw-items-center tw-gap-3">
                ...
                <div class="tw-h-7 tw-w-[1.5px] tw-bg-n300"></div>
                <img src="{{ asset('assets/logo/polinema.png') }}" alt="" class="tw-h-8">
        ...
        <div class="tw-flex tw-flex-col tw-gap-3">
            ...
            <ul class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 tw-gap-2 lg:tw-gap-5">
                <div class="tw-flex tw-flex-col tw-gap-2">
                    <li><a target="_blank" href="https://linkedin.com/in/ahmadtaufiqhidayatulloh" class="tw-font-medium tw-text-n1000 hover:tw-text-b500">Ahmad Taufiq Hidayatulloh</a></li>
                    <li><a target="_blank" href="" class="tw-font-medium tw-text-n1000 hover:tw-text-b500">Amanda Vanika Putri</a></li>
                    <li><a target="_blank" href="https://github.com/reysilvaa" class="tw-font-medium tw-text-n1000 hover:tw-text-b500">Moch. Reynald Silva Baktiar</a></li>
                </div>
                <div class="tw-flex tw-flex-col tw-gap-2">
