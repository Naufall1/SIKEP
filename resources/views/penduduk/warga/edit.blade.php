                ...
                <div id="formInput" class="tw-flex tw-flex-col tw-gap-7 tw-divide-y-[1.5px] tw-divide-n400">
                    ...
                    <div class="tw-flex tw-flex-col tw-gap-2">
                        ...
                        <div class="tw-flex tw-flex-col tw-gap-3" id="identitasWarga">
                            ...
                            <x-input.label required class="tw-relative" for="pendidikan-list" label="Pendidikan">
                            ...
                            <x-input.label required class="tw-relative" for="jenis_demografi_keluar-list"
                                label="Status Warga">
                        ...
                        <div class="tw-flex tw-flex-col tw-gap-3">
                            ...
                            <x-input.label for="penghasilan" label="Penghasilan">
                                <x-input.leadingicon type="number" value="{{ $warga->penghasilan }}" min="0"
                                    id="penghasilan" name="penghasilan" placeholder="HERE" icon="rupiah"
                                    alt="Rp">
                                </x-input.leadingicon>
                            </x-input.label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#jenis_demografi_keluar').change(function() {
                ...
                `;
                if (selectedStatusWarga !== '{{ $demografi ? $demografi->demografi->jenis : '' }}' && !$(
                        '#berkas_demografi_keluar').length) {
                            console.log('disisis');
                    $('#identitasWarga').append(tanggalKejadian);
                    $('#identitasWarga').append(fileStatusWarga);
                    $('#demografiMasuk').css('display', 'none');
                } else if (selectedStatusWarga ===
                    '{{ $demografi ? $demografi->demografi->jenis : '' }}') {
                    $('#berkas_demografi_keluar').parent().parent().remove();
                    $('#tanggal_kejadian_demografi_keluar').parent().remove();
                    $('#berkas').remove();
                    $('#demografiMasuk').css('display', 'flex');
