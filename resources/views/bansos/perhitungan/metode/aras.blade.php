    ...
    <div class="tw-flex tw-flex-col tw-gap-7">
        ...
        <div class="tw-flex tw-flex-col tw-gap-7 tw-divide-y-[1.5px] tw-divide-n400">
            ...
            <div class="tw-flex tw-flex-col tw-gap-2 tw-pt-6 tw-animate-fade-right tw-animate-ease-in-out tw-animate-duration-[600ms] tw-animate-delay-[2400ms]">
                <h2 class="">Tahap 4 - Nilai Fungsi Optimalisasi</h2>
                <div class="tw-flex tw-flex-col tw-gap-3">
                    {{-- Start: Table HERE --}}
                    <div class="tw-w-vw tw-overflow-x-auto tw-pb-3 md:tw-pb-0 tw-flex tw-flex-col tw-gap-6">
            ...
            <div class="tw-flex tw-flex-col tw-gap-2 tw-pt-6 tw-animate-fade-right tw-animate-ease-in-out tw-animate-duration-[600ms] tw-animate-delay-[2600ms]">
                <h2 class="">Tahap 5 - Menentukan Peringkat</h2>
                <div class="tw-flex tw-flex-col tw-gap-3">
                    {{-- Start: Table HERE --}}
                    <div class="tw-w-vw tw-overflow-x-auto tw-pb-3 md:tw-pb-0 tw-flex tw-flex-col tw-gap-6">
...
@push('js')
    <script>
        $(document).ready(function() {
            ARASMatriksKeputusan = $('#ARAS-MatriksKeputusan').DataTable({
                serverSide: true, // serverSide: true, jika ingin menggunakan server side processing
                ajax: {
                    "url": "{{ route('spk.aras.matriksKeputusan') }}",
                    "dataType": "json",
                    "type": "POST",
                },
                dom: 'tp',
            ...
            ARASNormalisasi1 = $('#ARAS-Normalisasi-1').DataTable({
                serverSide: true, // serverSide: true, jika ingin menggunakan server side processing
                ajax: {
                    "url": "{{ route('spk.aras.matriksTrnormalisasi_1') }}",
                    "dataType": "json",
                    "type": "POST",
                },
                dom: 'tp',
            ...
            ARASNormalisasi2 = $('#ARAS-Normalisasi-2').DataTable({
                serverSide: true, // serverSide: true, jika ingin menggunakan server side processing
                ajax: {
                    "url": "{{ route('spk.aras.matriksTrnormalisasi_2') }}",
                    "dataType": "json",
                    "type": "POST",
                },
                dom: 'tp',
            ...
            ARASMatriksTerbobot = $('#ARAS-MatriksTerbobot').DataTable({
                serverSide: true, // serverSide: true, jika ingin menggunakan server side processing
                ajax: {
                    "url": "{{ route('spk.aras.matriksTerbobot') }}",
                    "dataType": "json",
                    "type": "POST",
                },
                dom: 'tp',
            ...
            ARASFungsiOptimalisasi = $('#ARAS-FungsiOptimalisasi').DataTable({
                serverSide: true, // serverSide: true, jika ingin menggunakan server side processing
                ajax: {
                    "url": "{{ route('spk.aras.nilaiFungsiOptimal') }}",
                    "dataType": "json",
                    "type": "POST",
                },
                dom: 'tp',
            ...
            ARASPeringkat = $('#ARAS-Peringkat').DataTable({
                serverSide: true, // serverSide: true, jika ingin menggunakan server side processing
                ajax: {
                    "url": "{{ route('spk.aras.peringkatUtilitas') }}",
                    "dataType": "json",
                    "type": "POST",
                },
                dom: 'tp',
