...
<span {{ isset($id) ? 'id="' . $id . '"' : '' }}
    ...
    <svg width="{{ isset($size) ? $size : 25 }}" height="{{ isset($size) ? $size : 24 }}" viewBox="0 0 25 24" fill="none"
        ...
        <path
            ...
            stroke-width="{{ $stroke }}" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M16.157 12.7C15.897 14.11 14.747 15.26 13.337 15.52" stroke-width="{{ $stroke }}"
            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M10.117 14.53L2.64703 22" stroke-width="{{ $stroke }}" stroke-miterlimit="10"
            stroke-linecap="round" stroke-linejoin="round" />
        <path d="M22.647 2L15.177 9.47" stroke-width="{{ $stroke }}" stroke-miterlimit="10" stroke-linecap="round"
