...
Route::prefix('publikasi')->group(function () {
    Route::get('/', [ArticleAnnouncementController::class, 'index_publikasi'])->name('publikasi')->middleware(['auth','role:adm']); // menampilkan halaman yang berisi tabel daftar publikasi
    Route::post('/list', [ArticleAnnouncementController::class, 'list_publikasi'])->name('publikasi.list')->middleware(['auth','role:adm']); // menampilkan halaman yang berisi tabel daftar publikasi
    ...
    Route::get('/{id}/ubah', [ArticleAnnouncementController::class, 'edit_publikasi'])->name('publikasi.ubah')->middleware(['auth','role:adm']); // menampilkan detail dari sebuah publikasi
    Route::put('/{id}/ubah', [ArticleAnnouncementController::class, 'update_publikasi'])->name('publikasi.update')->middleware(['auth','role:adm']);// menyimpan data

    Route::get('/tambah', [ArticleAnnouncementController::class, 'create'])->name('publikasi.tambah')->middleware(['auth','role:adm']); // menampilkan form untuk menambahkan sebuah article atau pengumuman
    Route::post('/tambah', [ArticleAnnouncementController::class, 'store'])->name('publikasi.store')->middleware(['auth','role:adm']); // mmelakukan proses menerima data dari form penambahan data dan mrnyimpannya pada databse


    Route::get('/draf', [ArticleAnnouncementController::class, 'index_draf'])->name('publikasi.draf')->middleware(['auth','role:adm']); // menampilkan halaman yang berisi tabel daftar draf publikasi
    Route::post('/draf/list', [ArticleAnnouncementController::class, 'list_draf'])->name('publikasi.draf.list')->middleware(['auth','role:adm']); // menampilkan halaman yang berisi tabel daftar draf publikasi
    Route::get('/draf/{id}/detail', [ArticleAnnouncementController::class, 'show_draf'])->name('publikasi.draf.detail')->middleware(['auth','role:adm']); // menampilkan detail dari sebuah draf publikasi
    Route::get('/draf/{id}/ubah', [ArticleAnnouncementController::class, 'edit_draf'])->name('publikasi.draf.ubah')->middleware(['auth','role:adm']); // menampilkan detail dari sebuah draf publikasi
    Route::put('/draf/{id}/ubah', [ArticleAnnouncementController::class, 'update_draf'])->name('publikasi.draf.update')->middleware(['auth','role:adm']); // menyimpan data
